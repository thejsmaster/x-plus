...
export declare const callSet: (
  label: string,
  fn: Function,
  ...props: any
) => void;
export declare const useXChannel: (
  channelName: string,
...
export declare function findDiff(
  obj1: any,
  obj2: any,
  path?: string
): Record<string, any>;
export declare function useXOnAction(
  fnCallback: Function,
  actions: Function[]
): void;
export declare function useX<T extends Object>(
  CL: new () => T
): {
  state: T;
  set: (actionMethod: Function, ...propsToAction: any) => void;
...
export declare const LabelRenderer: ({
  label,
}: any) => import("react/jsx-runtime").JSX.Element;
export declare const StateView: ({
  state,
  boldFont,
  autoOpenFirstLevel,
}: any) => import("react/jsx-runtime").JSX.Element;
...
export declare function XPlusWrapper(
  props: TXDevToolsProps
): import("react/jsx-runtime").JSX.Element;
export declare const Treeview: ({
  state,
  autoOpenFirstLevel,
}: any) => import("react/jsx-runtime").JSX.Element;
export declare const UseXDevTools: ({
  XIconPosition,
  enableConsoleLogging,
  hideXPlusIcon,
  disableToggleESCKey,
}: TXDevToolsProps) => import("react/jsx-runtime").JSX.Element;
export declare const ValueRenderer: ({
  text,
}: any) => import("react/jsx-runtime").JSX.Element;
...
export declare const useXFetch: (
  url?: string,
  qsObj?: Object | null,
  method?: string,
  payload?: any,
...
export declare function xEvents<T extends string>(
  arr: T[]
): Record<
  T,
  {
...
export declare function usePagination(
  ...
  next: () => void;
  prev: () => void;
  setTotalPages: import("react").Dispatch<
    import("react").SetStateAction<number>
  >;
  itemsPerPage: number;
  totalPages: number;
  setItemsPerPage: import("react").Dispatch<
    import("react").SetStateAction<number>
  >;
  resetPage: () => void;
};
export declare function hasScrollReachedTheEnd(
  event: any,
  reverse?: boolean
): boolean;
